...
namespace ST_UtilidadesDroid.IO
{
    ...
    public class FileManager //: AMF.IO.AMF_FileManager
    {
        ...
        public async Task<IEnumerable<ST_Utilidades.IO.FileAttributes>> ListFileAttributes(string directoryName, string searchRegEx = ".*")
        {
            ...
            var result = new List<ST_Utilidades.IO.FileAttributes>();

            foreach (var file in filePaths)
            {
                result.Add(new ST_Utilidades.IO.FileAttributes
                {
