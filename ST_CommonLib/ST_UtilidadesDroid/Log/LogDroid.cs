...
using ST.Utilidades.Constantes;
using ST.Utilidades.Log;
using ST.UtilidadesDroid.IO;
using static Android.Provider.SyncStateContract;

namespace ST.UtilidadesDroid.Log
{
    public static class Log 
    {
        ...
        public static void InitLog(string proceso)
        {
            try
            {
                ST.Utilidades.Log.Log.NombreProceso = proceso;
        ...
        {
            ST.Utilidades.Log.Log.AddAlerta(user,  asunto,  mensaje,  nombreProcesoEnElasunto ,  nombreConFechaEnCuerpo );
        }
        ...
        {
            ST.Utilidades.Log.Log.AddAlerta(direccionesEmail, asunto, mensaje, nombreProcesoEnElasunto, nombreConFechaEnCuerpo);
        }
        ...
        {
            ST.Utilidades.Log.Log.AddCritical(mensaje, ex);
        }
        ...
        {
            ST.Utilidades.Log.Log.AddCritical(mensaje);
        }
        #endregion
        ...
        {
            ST.Utilidades.Log.Log.AddLineasVacias(nLineas);
        }
        /// <summary>
        ...
        {
            ST.Utilidades.Log.Log.AddNormal(mensaje);
        ...
        {
            ST.Utilidades.Log.Log.AddNormal(metodo, mensaje);
        }
        ...
        {
            ST.Utilidades.Log.Log.AddDebug(mensaje);
        ...
        {
            ST.Utilidades.Log.Log.AddDiffTime(mensaje, tiempoRef);
        }
        ...
        {
            ST.Utilidades.Log.Log.AddAvertencia(mensaje);
        }
        ...
        public static void AddHigh(string mensaje)
        {
            ...
            try
            {
                ...
                ST.Utilidades.Log.Log.AddHigh(mensaje);
        ...
        private static void mandarLogsPorEmail(string fileZip)
        {
            ...
            mail.Asunto = "Error Fatal en " + ST.Utilidades.Log.Log.NombreProceso;
